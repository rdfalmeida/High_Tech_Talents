...
CREATE INDEX "contrato_locatario_index" ON
    "contrato"("locatario");
CREATE TABLE "termos"(
    "id_termos" INTEGER NOT NULL,
    "termo_1" TEXT NOT NULL
);
ALTER TABLE
    "termos" ADD PRIMARY KEY("id_termos");
ALTER TABLE
...
ALTER TABLE
    "contrato" ADD CONSTRAINT "contrato_termos_foreign" FOREIGN KEY("termos") REFERENCES "termos"("id_termos");